    ...
    return (
        <div className="flex items-center justify-center py-24">
            <div className="w-full max-w-md bg-secondary p-8 rounded-2xl shadow-lg">
                <h2 className="text-3xl font-bold text-white text-center mb-6">Créez Votre Compte</h2>
                <form onSubmit={handleSignup} className="space-y-6">
                    ...
                    <div>
                     ...
                     <div>
                        <label className="block text-sm font-medium text-light mb-2">Confirmez le mot de passe</label>
                        <input type="password" required className="w-full bg-primary text-white p-3 rounded-lg border border-accent focus:ring-2 focus:ring-highlight-green focus:outline-none" />
                    </div>
                    <button type="submit" className="w-full bg-highlight-green text-primary font-bold py-3 px-4 rounded-lg text-lg hover:bg-green-400 transition-all duration-300">S'inscrire & Commencer à Gagner</button>
                </form>
            </div>
        </div>
    );
